...
## Project Structure
    ...
    ├── trust_business_bank_44195  # Django project configurations
...
1. Clone this repo and `cd trust_business_bank_44195`
...
2. Clone this repo and `cd trust_business_bank_44195`
